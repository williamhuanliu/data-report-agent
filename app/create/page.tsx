...
import type { CreateMode, CreateStep, ParsedData, ReportOutline } from '@/lib/types';
import { parseExcelFile } from '@/lib/excel-parser';
import { getFriendlyErrorMessage, validateFileSize } from '@/lib/error-messages';

const STEP_ORDER: CreateStep[] = ['mode', 'input', 'outline', 'theme', 'generating'];
...
function CreatePageContent() {
  ...
  const updateURL = useCallback((newStep: CreateStep, newMode: CreateMode | null) => {
