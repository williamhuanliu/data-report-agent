...
- ChatGPT 等 AI 输出的内容`}
            rows={12}
            className="w-full rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--surface)] px-4 py-3 text-[var(--foreground)] placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-[var(--border-focus)] resize-none font-mono text-sm"
          />
        </div>
